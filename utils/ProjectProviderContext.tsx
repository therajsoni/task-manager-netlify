...
export const ProjectDataContextProvider = ({ children }: { children: ReactNode }) => {
    ...
    const fetchAll = async () => {
        ...
        if (response?.success) {
            ...
            const projectList = projectData?.map((item: singleProjectType) => item.name);
    ...
    const updateProjectStatus = async ({ newData, id }: UpdateProjectTeamType) => {
        setLoading(true);
