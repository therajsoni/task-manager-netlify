...
//   stateAlert, setStateAlert, projectDeatils
// }:
//   {
//     stateAlert: boolean,
...
//                 })
//               }} placeholder="Title" className="w-full" />
//             <Textarea
...
//                 })
//               }} placeholder="Alert description" className="w-full" />
//             <button
//               type="button"
...
//             >
//               {
//                 loading ? <Loader size={24} className="animate-spin" /> : <Send size={24} />
//               }
//             </button>
//           </div>
...
//               <Label>
//                 <p className="mt-2 text-gray-700">{selectedAlert?.text?.description}</p>
//               </Label>
