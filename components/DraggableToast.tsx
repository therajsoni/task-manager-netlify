...
//     >
//       <h1 className="underline decoration-double text-lg">{data.title}</h1>
//       <main className="text-sm">{data.description}</main>
//       <footer className="text-xs text-gray-500 mt-2">
//         by {data.createdBy} at {data.time.toLocaleString()}
//       </footer>
//       <hr className="my-2" />
